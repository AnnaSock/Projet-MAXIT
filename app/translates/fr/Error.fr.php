...
// $field = 'email';
// echo sprintf(FrErrorMessages::REQUIRED->value, $field);
// Résultat : "Le champ email est requis"

// echo sprintf(FrErrorMessages::MIN->value, 'mot de passe', 8);
// Résultat : "Le champ mot de passe doit contenir au moins 8 caractères"